...
Цель: освоить упаковку в контейнеры приложений на Python, Go и Rust,
...
• Особенности сборки Go-приложений в Docker (статическая компиляция, scratch-образы).

• Особенности сборки Rust-приложений (musl, кросс-компиляция).
...
 Docker для Go: https://docs.docker.com/language/golang/

 Docker для Rust: https://docs.docker.com/language/rust/
